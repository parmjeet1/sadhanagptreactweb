...
const GoogleButton = () => {
  ...
  return (
    <button
      ...
      disabled={isLoading}
      className={`w-full max-w-[340px] flex items-center justify-center gap-3 bg-white border border-[#e2e8f0] rounded-full py-3.5 px-6 text-[#0f172a] font-bold text-[15px] shadow-sm transition-all outline-none ${isLoading ? 'opacity-70 cursor-not-allowed' : 'hover:bg-gray-50 active:scale-[0.98]'}`}
    >
      {isLoading ? (
