  ...
  const fetchAnalytics = () => {
    ...
    getRequest('/student-activities-analytics', payload, (response) => {
      ...
      const mapped = payloadArray.map(act => {
        ...
        const unit = (act.unit || '').toLowerCase();
        ...
        if (isTimeNode) {
          ...
          resolvedLabel = 'Time';
        } else if (t === 'min' || t === 'duration' || unit === 'min' || l.includes('min')) {
          resolvedColor = '#20c997';
          resolvedLabel = 'Mins';
        } else if (n.includes('chant')) {
          resolvedColor = '#1a73e8'; resolvedLabel = 'Rounds';
        } else if (n.includes('read')) {
          resolvedColor = '#a855f7'; resolvedLabel = 'Pages';
        } else if (n.includes('meditat') || n.includes('hear')) {
          resolvedColor = '#20c997'; resolvedLabel = 'Mins';
        } else if (t === 'numb' || t === 'count') {
          resolvedColor = '#f59e0b'; resolvedLabel = 'Count';
        } else if (t === 'boolean' || t === 'yes/no' || t === 'yes_no') {
          resolvedColor = '#10b981'; resolvedLabel = 'Times';
        }
